 ...
 */
export type DataType = 'UUID' | 'TEXT' | 'VARCHAR' | 'INTEGER' | 'BIGINT' | 'NUMERIC' | 'BOOLEAN' | 'DATE' | 'TIMESTAMP' | 'JSON';
/**
 ...
 */
export type GenerationStage = 'SUBMITTED' | 'MODELING' | 'REFINING' | 'SCHEMA_GEN' | 'VERIFYING' | 'DEPLOYING' | 'API_GEN' | 'DEPLOYED' | 'FAILED';
/**
