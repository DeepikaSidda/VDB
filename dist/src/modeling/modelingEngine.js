...
import { inferModelFromRecords, inferModelAndSeedFromRecords, inferModelAndSeedFromSheets } from './records.js';
...
export class ModelingEngine {
     ...
     */
    async inferFromRecords(records) {
     ...
     */
    async inferAndSeedFromRecords(records) {
     ...
     */
    async inferAndSeedFromSheets(sheets) {
