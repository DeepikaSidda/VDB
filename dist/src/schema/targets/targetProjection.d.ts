 ...
 */
export declare const SUPPORTED_TARGETS: readonly DeploymentTargetKind[];
/**
 ...
 */
export declare function isSupportedTarget(target: string): target is DeploymentTargetKind;
