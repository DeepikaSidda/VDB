 ...
 */
import { generateRelational } from './relational.js';
/**
 ...
 */
export function generateAuroraDsql(model) {
    return generateRelational(model, 'AURORA_DSQL');
}
/**
 * The Aurora DSQL {@link TargetProjection} plug-in.
 */
export const auroraDsqlProjection = {
    target: 'AURORA_DSQL',
    generate: generateAuroraDsql,
};
//# sourceMappingURL=auroraDsql.js.map