 ...
 */
import { err } from '../model/result.js';
...
import { SUPPORTED_TARGETS, isSupportedTarget, } from './targets/targetProjection.js';
...
export { DATA_TYPE_TO_POSTGRES, mapDataType, } from './targets/relational.js';
// Re-export the target-projection surface for callers that want the DynamoDB
// report or the projection abstraction directly.
export { SUPPORTED_TARGETS, isSupportedTarget, } from './targets/targetProjection.js';
export { generateDynamoDbDesign, } from './targets/dynamodb.js';
/**
 ...
 */
export function generate(model, target = 'POSTGRES') {
    ...
    if (!isSupportedTarget(target)) {
        return err({
            ...
            message: `Unsupported deployment target "${target}". Supported targets are: ` +
    ...
    switch (target) {
        ...
        default: {
            ...
            return err({
                kind: 'UNSUPPORTED_TARGET',
                message: `Unsupported deployment target "${String(target)}". Supported ` +
