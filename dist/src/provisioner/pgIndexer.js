...
const TEXTUAL = new Set(['TEXT', 'VARCHAR']);
...
function indexName(entity, column, kind) {
 ...
 */
export async function createSearchIndexes(target, schema, model) {
...
//# sourceMappingURL=pgIndexer.js.map